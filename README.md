...
The goal of this project is to create an application that processes all the videos generated by my Xiaomi security camera and do a visual inspection of each to ensure that only videos where a person is detected will send a notification to your mobile. When you receive this notification, you will be able to see what triggered the camera inside a bounding box and also the original video for closer inspection.
