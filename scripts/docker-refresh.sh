...
rm -fr ~/camera_latest/tensorflow-with-object-recognition/credentials
cp -r ~/project/credentials ~/camera_latest/tensorflow-with-object-recognition/credentials
